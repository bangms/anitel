...
<body>
	...
	<form action="adminMemberQnADeletePro.jsp" method="post">
		...
		<table align="center">
			...
			<script>
				opener.parent.location='/anitel/anitel/adminMypage/adminMemberQnAForm.jsp';
			</script>
			<tr>
				<td><br/>
					<input type="submit" value="OK" onclick="window.location='/anitel/anitel/adminMypage/adminMemberQnADeletePro.jsp'"/>&emsp;
