			...
			<div class="table_wrap">
			  ...
			  <ul class="responsive-table">
			    <li class="table-header">
			      ...
			      <div class="col col-3" style="flex-basis: 17%;">사업자아이디</div>
				...
				%>
			      ...
			      <div class="col col-4" style="flex-basis: 17%;" data-label="subject"><a class="list_subject" href="../board/content.jsp?board_num=<%=user.getBoard_num()%>&categ=1"><%=user.getSubject() %></a></div>
			      ...
			      <div class="col col-6" style="flex-basis: 17%;" data-label="comm">
			      	<%if(user.getComm() == 0) {%>
			         	 <input type="button" class="t_btn" style="width: 100px" value="답변하기" onClick="window.location='../board/replyForm.jsp?board_num=<%=user.getBoard_num()%>&categ=1'"/>					
