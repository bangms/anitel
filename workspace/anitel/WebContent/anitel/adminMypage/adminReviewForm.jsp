			...
			<div class="table_wrap">
			  ...
			  <ul class="responsive-table">
				...
				<li class="table-row">
			      ...
			      <div class="col col-2" style="flex-basis: 15.833%;" data-label="date"><%=sdf.format(review.getReg_date())%></div>
			      <div class="col col-3" style="flex-basis: 15.833%;" data-label="userID"><%=review.getId()%></div>
			      <div class="col col-4" style="flex-basis: 15.833%;" data-label="hotelName"><%=review.getHotel_name()%></div>
			      <div class="col col-5" style="flex-basis: 15.833%;" data-label="subject"><a class="list_subject" href="../board/content.jsp?board_num=<%=review.getBoard_num()%>&categ=3&pageNum=<%=pageNum%>"><%=review.getSubject()%></a></div>
			      <div class="col col-6" style="flex-basis: 15.833%;" data-label="re">
					<% if(review.getReg_date() != null) {%>
						<%=sdf.format(review.getReg_date()) %>
					<%} %>
			      </div>
