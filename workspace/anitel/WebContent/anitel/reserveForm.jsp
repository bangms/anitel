			...
			<div class="userinfo_wrapper">
				...
				<hr />
					...
					<div id="rs">
						...
						<input type="text" name="pet_name" value="" /></p>
						<p><strong>반려동물 종</strong>
						<input type="text" name="pet_type" value="" /></p>
						<p><strong>반려동물 성별</strong>
						<input type="text" name="pet_gender" value="" /></p>
						<p><strong>반려동물 나이</strong>
						<input type="text" name="pet_age" value="" /></p>
						<p><strong>대형견 여부</strong>
						<input type="text" name="pet_big" value="" /></p>
						<p><strong>중성화</strong>
						<input type="text" name="pet_operation" value="" /></p>
					</div>
