			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<input type="button" id="select" value="선택" onclick="window.location='ReserveForm.jsp?memId=<%=memId%>&room_num=<%=roomNum%>&check_in=<%=check_in%>&check_out=<%=check_out%>&pet_num=<%=pet.getPet_num()%>'" />
					</td>
				</tr>
				<tr>
					<td>반려동물 종류</td>
